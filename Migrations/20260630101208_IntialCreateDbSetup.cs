...
{
    /// <inheritdoc />
    public partial class IntialCreateDbSetup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AssessmentInvitations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CandidateId = table.Column<int>(type: "int", nullable: false),
                    AssessmentToken = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssessmentInvitations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CandidateId = table.Column<int>(type: "int", nullable: false),
                    AadhaarPath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PanPath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DegreeCertificatePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExperienceCertificatePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
